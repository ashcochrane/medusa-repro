...
import { CompanyActionsMenu, EmployeeCreateDrawer, EmployeesActionsMenu } from "../../../components";
import { useCompany } from "../../../hooks";
import { formatAmount } from "../../../utils";
import { EmployeeDTO } from "src/modules/company/dtos";

const CompanyDetails = () => {
  const { id } = useParams();
  const { data, loading, refetch } = useCompany(id!, {
            ...
            <Table>
              <Table.Body>
                ...
                <Table.Row>
                  ...
                  <Table.Cell>{company?.address_1}</Table.Cell>
                </Table.Row>
                <Table.Row>
                  <Table.Cell className="font-medium font-sans txt-compact-small">
                    City
                ...
                <Table.Row>
                  ...
                  <Table.Cell>{company?.province}</Table.Cell>
                </Table.Row>
                <Table.Row>
                  <Table.Cell className="font-medium font-sans txt-compact-small">
                    Currency
